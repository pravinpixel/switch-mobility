                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <a href="{{ route('users.edit', $d['id']) }}" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3">
                                        ...
                                        <a class="btn btn-icon btn-active-light-primary w-30px h-30px me-3" href="javascript:void(0);" class="menu-link px-3" onclick="delete_item(<?php echo $d['id']; ?>);">
                                            ...
                                            <span class="svg-icon svg-icon-3" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Delete">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
