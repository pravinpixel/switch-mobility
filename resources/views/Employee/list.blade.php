                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-850px">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                ...
                                                <form name="createForm" id="designation_form1" class="form" method="post"
                                                    enctype="multipart/form-data" action="{{ url('employees') }}"
                                                    pkey="">
                                                    @csrf
                                                    ...
                                                    <div class="row g-9 mb-7">
                                                        ...
                                                        <div class="col-md-6 fv-row">
                                                            ...
                                                            <!--begin::Input-->
                                                            <input type="email"
                                                                class="form-control form-control-solid email"
                                                        ...
                                                        <div class="col-md-6 fv-row">
                                                            ...
                                                            <input type="text" pattern="\d*"
                                                                class="form-control form-control-solid mobile"
                                                        ...
                                                        <div class="col-md-6 fv-row">
                                                            <!--begin::Label-->
                                                            <label
                                                                class="required fs-6 fw-semibold mb-2">Department</label>
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                        ...
                                                        <div class="col-md-6 fv-row">
                                                            <!--begin::Label-->
                                                            <label
                                                                class="required fs-6 fw-semibold mb-2">Designation</label>
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <select class="form-control form-control-solid"
                                                                name="designation_id">
                                                        ...
                                                        <div class="col-md-6 fv-row">
                                                            ...
                                                            <!--begin::Input-->
                                                            <input type="text"
                                                                class="form-control form-control-solid sapId"
                                                                placeholder="Enter SAP-id" name="sap_id" />
                        ...
                        <div class="card-body py-4">
                            <div class="card-header  py-3 gap-1 gap-md-5">
                                ...
                                <div class="w-100 mw-150px"  style="display: none">
                                    <!--begin::Select2-->
                                    <select class="form-select form-select-solid emplySelect" data-kt-select2="true"
                                        data-placeholder="SAP_id" data-allow-clear="true">
                                        <option></option>
                                        @foreach ($employee as $emply)
                                ...
                                <div class="w-100 mw-150px"  style="display: none">
                                    <!--begin::Select2-->
                                    <select class="form-select form-select-solid  emplySelect" data-kt-select2="true"
                                        data-placeholder="Mobile" data-allow-clear="true">
                                        <option></option>
                                        @foreach ($employee as $emply)
                                ...
                                <div class="w-250px mw-250px">
                                    <!--begin::Select2-->
                                    <select class="form-select form-select-solid filterDeptAndDes" data-kt-select2="true"
                                        data-placeholder="Desgination" data-allow-clear="true" id="designationFilter">
                                        <option></option>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex align-items-center">
                                                ...
                                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                    <a href="javascript:void(0);">
                                                        <div class="symbol-label">
                                                            <img src="{{ asset('images/' . $d->profile_image) }}"
                                                                alt="{{ $d->first_name }}" width="50" height="50"
                                                                class="w-100" /> 
                                                        </div>
                                                    </a>
                                                </div>
                                                ...
                                                <div class="d-flex flex-column">
                                                    <a href="javascript:void(0);"
                                                        class="text-gray-800 text-hover-primary mb-1"><?php echo $d->first_name . ' ' . $d->last_name; ?></a>
                                            ...
                                            <td>
                                                <label class="switch">
                                                    <input type="checkbox" data-id="{{ $d->id }}" value=""
                                                        class="status" <?php echo $d->is_active == 1 ? 'checked' : ''; ?>>
                                                ...
                                                <div class="d-flex my-3 ms-9">
                                                    ...
                                                    @if (auth()->user()->is_super_admin == 1 ||
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            data-bs-target="#kt_modal_add_customer<?php echo $d->id; ?>">
            ...
            <div class="modal-dialog modal-dialog-centered mw-850px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <form name="editForm" id="designation_form1" class="form" method="post"
                            enctype="multipart/form-data" action="{{ url('employees') }}" pkey="{{ $d->id }}">
                            @csrf
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <label class="form-check form-switch form-check-custom form-check-solid">In Active
                                        ...
                                        <input class="form-check-input" name="is_active" type="checkbox" value="1"
                                            id="kt_modal_add_customer_billing" <?php if ($d->employee_status == 1) {
                                                echo 'checked';
                                            } ?> />
                                        <!--end::Input-->
                                        <!--begin::Label-->
                                        <span class="form-check-label fw-semibold text-muted"
                                            for="kt_modal_add_customer_billing">Active</span>
                                        <!--end::Label-->
                                    </label>
                                    <!--end::Switch-->
                                </div>
                            ...
                            <div class="row g-9 mb-7">
                                ...
                                <div class="col-md-6 fv-row">
                                    ...
                                    <input type="text" required class="form-control form-control-solid"
                                        placeholder="Enter First Name" name="first_name" value="{{ $d->first_name }}" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Col-->
                                ...
                                <div class="col-md-6 fv-row">
                                    ...
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid"
                                        placeholder="Enter Last Name" name="last_name" value="{{ $d->last_name }}" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Col-->
                                ...
                                <div class="col-md-6 fv-row">
                                    ...
                                    <input type="email" class="form-control form-control-solid email"
                                        placeholder="Enter Email" name="email" value="{{ $d->email }}" required />
                                    <!--end::Input-->
                                </div>
                                <!--end::Col-->
                                ...
                                <div class="col-md-6 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" class="form-control form-control-solid mobile" pattern="\d*"
                                        placeholder="Enter Mobile" name="mobile" value="{{ $d->mobile }}"
                                ...
                                <div class="col-md-6 fv-row">
                                    ...
                                    <input type="text" class="form-control form-control-solid sapId"
                                        placeholder="Enter SAP-id" name="sap_id" value="{{ $d->sap_id }}"
                                        required />
                                    <!--end::Input-->
                                </div>
                                <!--end::Col-->
