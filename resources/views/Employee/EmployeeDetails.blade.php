                            ...
                            <form name="createForm" id="form" class="form" method="post"
                                ...
                                <div class="row g-9 mb-7">
                                    ...
                                    <div class="col-md-4 fv-row">
                                        ...
                                        if ($model) {
                                            $noPic = 'noimage.png';
                                            $profilePic = isset($model['profile_image']) ? e($model['profile_image']) : $noPic;
                                    ...
                                    <div class="col-md-4 fv-row">
                                        ...
                                        if ($model) {
                                            $noImage = 'noimage.png';
                                            $image = isset($model['sign_image']) ? e($model['sign_image']) : $noImage;
                                            $pic = $image;
                                        } else {
                                            $pic = 'noimage.png';
                                        }
                            ...
                            success: function(response) {
                                if (response.status == "success") {
                                    ...
                                    for (var i = 0; i < datas.length; i++) {
                                        raiseAlert(datas[i].alertField, datas[i].name,
                                            datas[i].type);
                                    }
                                }
                            },
