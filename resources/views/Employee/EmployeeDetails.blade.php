                    ...
                    <div class="card" style="width:900px;margin:auto;">
                        ...
                        <div class="card-body py-4">
                            ...
                            <form name="createForm" id="form" class="form" method="post"
                                enctype="multipart/form-data" action="{{ url('employees') }}" pkey="">
                                @csrf
                                ...
                                <div class="row g-9 mb-7">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid"
                                            value="<?php echo $model ? $model->first_name : ''; ?>" placeholder="Enter First Name" name="first_name"
                                            autocomplete="off" />
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid"
                                            placeholder="Enter Last Name" value="<?php echo $model ? $model->last_name : ''; ?>" name="last_name"
                                            autocomplete="off" />
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="email" class="form-control form-control-solid email"
                                            placeholder="Enter Email" name="email" value="<?php echo $model ? $model->email : ''; ?>"
                                            autocomplete="off" />
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="number" pattern="/^-?\d+\.?\d*$/"
                                            onKeyPress="if(this.value.length==10) return false;" value="<?php echo $model ? $model->mobile : ''; ?>"
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid sapId"
                                            value="<?php echo $model ? $model->sap_id : ''; ?>" placeholder="Enter SAP-ID" name="sap_id"
                                            autocomplete="off" />
                                    ...
                                    <div class="col-md-3 fv-row">
                                        ...
                                        <img id="blah" class="picture" style="display:none;" width="100"
                                            height="100" />
