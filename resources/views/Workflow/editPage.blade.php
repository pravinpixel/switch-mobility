                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="fullLevelFlow" data-kt-ecommerce-catalog-add-product="auto-options">
                                                ...
                                                $arrayN = 0;
                                                ?>
                                                @for($k=0;$k<11;$k++) <div id="kt_ecommerce_add_product_options1">
                                                    <?php $a = 11;
                                                    $b = $a - 1; ?>
                                                    <!--begin::Form group-->
                                                            ...
                                                            <div data-repeater-item="" class="form-group d-flex flex-wrap align-items-center gap-5">
                                                                ...
                                                                <div class="col-md-3 fv-row">
                                                                    <select class="form-select mb-2 designation" required data-control="select2" data-placeholder="Select an option" data-allow-clear="true" multiple="multiple" name="fapprover_designation{{$k+1}}[]">
                                                                        ...
                                                                        if(isset($entities[$k]['designationId'])){

                                                                        
                                                                        $option = $entities[$k]['designationId'];
                                                                        $selectedAttribute = '';
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="partialLevelFlow" data-kt-ecommerce-catalog-add-product="auto-options">
                                    <!--begin::Repeater-->
                                    @for($k=0;$k<count($entities);$k++) <div id="kt_ecommerce_add_product_options1">
                                            ...
                                            <div data-repeater-list="kt_ecommerce_add_product_options" class="d-flex flex-column gap-3">
                                                <div data-repeater-item="" class="form-group d-flex flex-wrap align-items-center justify-content-center gap-5">
                                                    ...
                                                    <div class="col-md-4 fv-row">
                                                        <select required class="form-select mb-2 designation" data-control="select2" data-placeholder="Select an option" data-allow-clear="true" multiple="multiple" name="approver_designation{{$entities[$k]['levelId']}}[]">
                                                            @foreach($designationDatas as $designationData)
