                        ...
                        <form class="form" method="post" action="{{url('documentType')}}">
                            ...
                            <div class="row g-9 mb-7">
                                ...
                                <div class="col-md-12 fv-row">
                                    ...
                                    <select class=" workflow_id form-select form-select-solid" data-kt-select2="true" data-placeholder="Select Workflow" data-allow-clear="false" name="workflow_id" onchange="get_work_flow_levels(this.value);" required>
