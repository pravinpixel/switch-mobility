                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="service_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">Planned Date</th>
                            ...
                            <div class="w-100">
                                ...
                                <div class="row g-9 mb-7">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid sap_id" placeholder="Enter SAP-id" name="sap_id" readonly />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Col-->
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid department" placeholder="Enter Department" name="department_id" readonly />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Col-->
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid designation" placeholder="Enter Designation" name="designation_id" readonly />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Col-->
                            ...
                            <div class="w-100">
                                ...
                                @for ($i = 0; $i <= 10; $i++) <div id="London<?php echo $i; ?>" class="tabcontent">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <select name="staff[]" class="employee_append<?php echo $i+1; ?> form-control staff<?php echo $i; ?>">
                                            <option value="">Select</option>
                                            @foreach ($employee as $emp)
                                            <option value="<?php echo $emp['id']; ?>"><?php echo $emp['first_name'] . ' ' . $emp['last_name']; ?></option>
                                            @endforeach
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                if(data.employees){
                    ...
                    .find('option')
                    .remove();
                    $(".employee_append"+level).prepend("<option value=''>Select</option>").val('');
