                    ...
                    <form id="designation_form kt_modal_create_campaign_stepper_form" class="form" method="post" enctype="multipart/form-data" action="{{ url('projects') }}">
                        ...
                        <div data-kt-stepper-element="content" style=" max-height: 370px;overflow-y: scroll;">
                            ...
                            <div class="w-100">
                                <!-- Levels Tab -->
                                <div class="tab">
                                    @for ($i = 0; $i <1; $i++) <button type="button" class="tablinks" <?php if ($i == 0) {
                                                                                                            echo "id='defaultOpen'";
                                                                                                        } else {
                                                                                                            echo "id='next'";
                ...
                if (WFLevelBtn) {
                    ...
                    for (var wfl = 0; wfl < WFLevelBtn.length; wfl++) {
                        ...
                        for (var lvldesc = 0; lvldesc < levelDesignation.length; lvldesc++) {
                            ...
                            levelTabContentData += '<select name="approver_"'+WFLevelBtn[wfl].levelId+'_"'+lvldesc+'[]" class="form-select form-select-solid" id="' + uniqueId + '" data-control="select2" data-placeholder="Select an option" data-allow-clear="true" multiple="multiple">';
