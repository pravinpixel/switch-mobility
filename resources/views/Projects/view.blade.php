        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                if (data.length) {
                    ...
                    $("#pag" + level).html('<div class="sv-tab-panel" ><div class="jumbotron"><div class="row"><div class="col-md-2">Approvers</div><div class="col-md-6 image_append' + level + '" style="display:inline-flex;flex-flow:row"></div><div class="col-md-4">Milestone:Pending<br>Milestone Start Date:Pending</div></div><hr><div class="doc_append' + level + '" style=" max-height:400px; overflow-y:auto"></div></div></div>');
                    //if (data.length > 0) {
