...
@section('content')
    <style>
        * {
        ...
        .radio-labels {
            display: flex;
            /* Display radio labels in a row */
            align-items: center;
            /* Center align radio labels vertically */
        }
                    ...
                    <div class="w-100">
                        ...
                        <div class="row g-9 mb-7">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="hidden" class="form-control initiator_id" placeholder="Enter Project Code"
                                    name="initiator_id" required />
                                <select class="form-control form-control-solid initiator_id1" name="initiator_id1" disabled
                ...
                <div class="col-md-12 fv-row">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="col-md-12 p-3 pdf_container input-group">
                            ...
                            </label> <input type="file" name="auxillary_document[]" id="pdf2" class="form-control border-0" onchange="pdfPreview(this)" style="display:none;" accept=".csv,.pdf,.xlsx,.xls,.doc,.docx">
                        </div>
                    </div>
                </div>
                <div class="tab">
...
<script>
                    ...
                    if (WFLevelBtn) {
                        ...
                        for (var wfl = 0; wfl < WFLevelBtn.length; wfl++) {
                            ...
                            levelTabContentData +=
                                ...
                                WFLevelBtn[wfl].levelId + '" name="priority[]" value="1" data-getLevel="' +
                                WFLevelBtn[wfl].levelId + '" > Important &nbsp;&nbsp;';
                            levelTabContentData +=
                                '<input id="low" type="checkbox" class="priority priority2' + WFLevelBtn[
                                    wfl].levelId + '" name="priority[]" value="2" data-getLevel="' +
                                WFLevelBtn[wfl].levelId + '"> Medium &nbsp;&nbsp;';
                            levelTabContentData +=
                                '<input id="medium" type="checkbox" class="priority priority3' + WFLevelBtn[
                                    wfl].levelId + '" name="priority[]" value="3" data-getLevel="' +
                                WFLevelBtn[wfl].levelId + '"> Low &nbsp;&nbsp;';
                            levelTabContentData +=
                                '<input id="high" type="checkbox" class="priority priority4' + WFLevelBtn[
                                    wfl].levelId + '" name="priority[]" value="4" checked data-getLevel="' +
                                WFLevelBtn[wfl].levelId + '"> High';
                            ...
                            levelTabContentData += '<select name = "' + uniqueApproverName +
                                '[]" class="form-select w-50 form-select-solid" id="' + uniqueId +
                            ...
                            for (var lvldesc = 0; lvldesc < levelDesignation.length; lvldesc++) {
                                ...
                                var optionData = levelDesignation[lvldesc].first_name + levelDesignation[
                                    ...
                                    "-(" + levelDesignation[lvldesc].designation_id + ")";
                ...
                if (WFLevelBtn) {
                    ...
                    for (var wfl = 0; wfl < WFLevelBtn.length; wfl++) {
                        ...
                        levelTabContentData +=
                            ...
                            '" name="priority[]" value="1" ' + check1 + ' data-getLevel="' + WFLevelBtn[wfl]
                            .levelId + '"> Important &nbsp;&nbsp;';
                        levelTabContentData += '<input id="low" type="checkbox" class="priority priority2' +
                            WFLevelBtn[wfl].levelId + ' getPriority' + WFLevelBtn[wfl].levelId +
                            '" name="priority[]" value="2" ' + check2 + ' data-getLevel="' + WFLevelBtn[wfl]
                            .levelId + '"> Medium &nbsp;&nbsp;';
                        levelTabContentData +=
                            '<input id="medium" type="checkbox" class="priority priority3' + WFLevelBtn[wfl]
                            .levelId + ' getPriority' + WFLevelBtn[wfl].levelId +
                            '" name="priority[]" value="3" ' + check3 + ' data-getLevel="' + WFLevelBtn[wfl]
                            .levelId + '"> Low &nbsp;&nbsp;';
                        levelTabContentData +=
                            '<input id="high" type="checkbox" class="priority priority4' + WFLevelBtn[wfl]
                            .levelId + ' getPriority' + WFLevelBtn[wfl].levelId +
                            '" name="priority[]" value="4" ' + check4 + ' data-getLevel="' + WFLevelBtn[wfl]
                            .levelId + '"> High ';
                        ...
                        for (var lvldesc = 0; lvldesc < levelDesignation.length; lvldesc++) {
                            ...
                            levelTabContentData += '<option value="' + optionId + '" ' + selectOption +
                                '>' + optionData + '</option>';
    ...
    function get_edit_details(project_id) {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $(".document_type_id1").val(data.project.document_type_id).attr("selected", "selected")
                    .select2();
                ...
                $.each(data.milestone, function(key, val) {
                    var s1 =
                        '<div class="multi-field"> <div class="row remove_append"> <div class="col-md-4 fv-row"> <!--begin::Label--> <label class="required fs-6 fw-semibold mb-2">Mile Stone</label> <!--end::Label--> <!--begin::Input--> <input type="text" class="form-control" name="milestone[]" value="' +
                        val.milestone +
                        '" oninput="set_mile_min_max();" required /> <!--end::Input--> </div> <!-- <div class="col-md-4 fv-row"> <label class="required fs-6 fw-semibold mb-2">Planned Date</label> <input type="date" class="form-control planned_date" name="planned_date[]" onclick="set_min_max_value();" required /> </div> --> <!--begin::Col--> <div class="col-md-2 fv-row"> <!--begin::Label--> <label class="required fs-6 fw-semibold mb-2">Start Date</label> <!--end::Label--> <!--begin::Input--> <input type="date" class="form-control form-control-solid mile_start_date" min="' +
                        data.project.start_date + '" max="' + val.mile_end_date + '" start-min="' +
                        data.project.start_date + '" start-max="' + data.project.end_date +
                        '" placeholder="Enter Start Date" name="mile_start_date[]" value="' + val
                        .mile_start_date +
                        '" onchange="mileStone_min_date(this)" required /> <!--end::Input--> </div> <!--end::Col--> <!--begin::Col--> <div class="col-md-2 fv-row"> <!--begin::Label--> <label class="required fs-6 fw-semibold mb-2">End Date</label> <!--end::Label--> <!--begin::Input--> <input type="date" class="form-control form-control-solid mile_end_date" placeholder="Enter End Date" name="mile_end_date[]" value="' +
                    ...
                    $.each(data.levelArray, function(key1, val1) {
                        var selectedCrosses = (val.levels_to_be_crossed == val1.levelId) ?
                            "selected" : "";
                        s1 += ' <option value="' + val1.levelId + '" ' + selectedCrosses +
                            '>Level -' + val1.levelId + '</option> ';
                    });
                    s1 +=
    ...
    function append_more(e) {
        ...
        if ($(".notifyAlert").length == 0) {
            if (length <= 11) {
                $('.multi-field:first-child').clone().appendTo(".multi-fields").find('input').val('').attr('min',
                    function() {
                        return $(this).attr('start-min');
                    }).attr('max', function() {
...
function downloadDocs(event){
    ...
    console.log(documentPath);
      ...
      var link = document.createElement('a');
            ...
            link.download = 'document_name.pdf'; // Replace with the desired file name
