...
validation=false;
    ...
    function append_more(e) {
        ...
        if ($(".notifyAlert").length == 0) {
            if (length <= 11) {
                $('.multi-field:first-child').clone().appendTo(".multi-fields").find('input').val('').attr('min', function() { return $(this).attr('start-min'); }).attr('max', function() { return $(this).attr('start-max'); });
