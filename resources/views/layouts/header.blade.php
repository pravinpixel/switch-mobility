                    ...
                    <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1"
                       ...
                       <!--begin::Menu wrapper-->
                        ...
                        <div class="app-navbar flex-shrink-0">
                          ...
                          if($pic){
                            $profiles=' <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
                                    data-kt-menu-trigger="{default: "click", lg: "hover"}"
                                    data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                               <img src="images/Employee/'.$pic.'" alt="user" width="48px" height="54px"/>
                                </div>';
                          }else{
                            $profiles='<div class="cursor-pointer symbol symbol-30px symbol-md-40px"
                                    data-kt-menu-trigger="{default: "click", lg: "hover"}"
                                    data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                               <img src="images/admin-icon-3.jpg" alt="user" width="48px" height="54px"/>
                                </div>';
                       ...
                       ?>
                            ...
                            <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                                <!--begin::Menu wrapper-->
                                <div class="cursor-pointer symbol symbol-30px symbol-md-60px"
                                    data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                    <a class="dropdown-item" href="{{ route('logout') }}"
                                        onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                        <img src="{{ asset('images/logout.jpg') }}" alt="user" width="40px"
                                            title="logout" /></a>
