                                            ...
                                            <form id="department_form" class="form" method="post" action="{{url('department')}}">
                                                ...
                                                <div class="row g-9 mb-7">
                                                    ...
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                        <input class="form-control form-control-solid" placeholder="Enter Department" name="name" required />
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Col-->
                                                    <!--begin::Col-->
                ...
                <form id="department_form1" method="post" action="{{url('department')}}">
                    ...
                    <div class="row g-9 mb-7">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input class="form-control form-control-solid" placeholder="Enter Department" name="name" value="{{$d['name']}}" required />
                            <!--end::Input-->
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
