                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            ...
                                            <form id="designation_form" class="form" method="post" action="{{url('designation')}}">
                                                @csrf
                                                ...
                                                <div class="row g-9 mb-7">
                                                    ...
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                        <input class="form-control form-control-solid" placeholder="Enter Designation" name="name" required />
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Col-->
                                                    <!--begin::Col-->
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <form id="designation_form1" method="post" action="{{url('designation')}}">
                    @csrf
                    ...
                    <div class="row g-9 mb-7">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input class="form-control form-control-solid" placeholder="Enter Designation" name="name" value="{{$d['name']}}" required />
                            <!--end::Input-->
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
