                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex my-3 ms-9">
                                            ...
                                            <a href="{{route('designation.edit',$d['id'])}}" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3">
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        $.each(result, function(key, val) {
                            ...
                            table.row.add([sNo, name, description, result, Action]).draw();
