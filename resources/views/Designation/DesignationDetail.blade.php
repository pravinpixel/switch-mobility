                            ...
                            <form class="form" method="post" action="{{ url('designation') }}">
                                ...
                                <div class="row g-9 mb-7">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid name"
                                            value="{{ $model ? e($model->name) : '' }}" placeholder="Enter Designation"
                                ...
                                <div class="row g-9 mb-7">
                                    ...
                                    <div class="col-md-12 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <textarea class="form-control form-control-solid" name="description" rows="4" cols="50">{{ $model ? e($model->description) : '' }}</textarea>
                                ...
                                <div class="text-center pt-15">
                                    ...
                                    <button onclick="deptValidation();" type="button"
                                        class="btn switchPrimaryBtn submitBtn" data-kt-users-modal-action="submit">
